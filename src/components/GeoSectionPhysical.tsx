// src/components/GeoSectionPhysical.tsx
...
export default function GeoSectionPhysical() {
  const { frontmatter, content } = loadMarkdown("src/content/geography/physical.md")
    ...
    <section className="relative min-h-screen px-6 md:px-10 py-16 bg-black text-slate-100">
      ...
      <div className="max-w-4xl mx-auto mb-6">
        <h1 className="text-3xl md:text-4xl font-bold text-amber-300">
          {frontmatter.title ?? "Physical Geography of China"}
        </h1>
